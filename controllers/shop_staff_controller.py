...
from services.shop_staff_service import ShopStaffService
from validations.shop_staff import validate_shop_staff


def list_shop_staffs(shop_id: int):
    result = ShopStaffService.list(shop_id, *pagination_parameters())
